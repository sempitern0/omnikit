class_name OmniKitBitStream extends RefCounted
...
func from_byte_array(byte_array: PackedByteArray) -> OmniKitBitStream:
	bits.clear()
...
func from_utf8(utf8_string: String) -> OmniKitBitStream:
