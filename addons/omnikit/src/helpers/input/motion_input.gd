...
func change_move_right_action(new_action: StringName) -> OmniKitMotionInput:
	if InputMap.has_action(new_action):
		...
		push_error("OmniKitMotionInput: The new move right action %s does not exist in the InputMap, create the action and then reassign it again" % new_action)
...
func change_move_left_action(new_action: StringName) -> OmniKitMotionInput:
	if InputMap.has_action(new_action):
		...
		push_error("OmniKitMotionInput: The new move left action %s does not exist in the InputMap, create the action and then reassign it again" % new_action)
...
func change_move_forward_action(new_action: StringName) -> OmniKitMotionInput:
	if InputMap.has_action(new_action):
		...
		push_error("OmniKitMotionInput: The new move forward action %s does not exist in the InputMap, create the action and then reassign it again" % new_action)
...
func change_move_back_action(new_action: StringName) -> OmniKitMotionInput:
	if InputMap.has_action(new_action):
		...
		push_error("OmniKitMotionInput: The new move back action %s does not exist in the InputMap, create the action and then reassign it again" % new_action)
...
func change_motion_right_action(new_action: StringName) -> OmniKitMotionInput:
	if InputMap.has_action(new_action):
		...
		push_error("OmniKitMotionInput: The new motion right action %s does not exist in the InputMap, create the action and then reassign it again" % new_action)
...
func change_motion_left_action(new_action: StringName) -> OmniKitMotionInput:
	if InputMap.has_action(new_action):
		...
		push_error("OmniKitMotionInput: The new motion left action %s does not exist in the InputMap, create the action and then reassign it again" % new_action)
...
func change_motion_up_action(new_action: StringName) -> OmniKitMotionInput:
	if InputMap.has_action(new_action):
		...
		push_error("OmniKitMotionInput: The new motion up action %s does not exist in the InputMap, create the action and then reassign it again" % new_action)
...
func change_motion_down_action(new_action: StringName) -> OmniKitMotionInput:
	if InputMap.has_action(new_action):
		...
		push_error("OmniKitMotionInput: The new motion down action %s does not exist in the InputMap, create the action and then reassign it again" % new_action)
